...
- **Include a**Have it in the repo and update it as code changes. The discovery agent can then read it before searching, skipping known non-issues.- `THREAT_MODEL.md`with the code.
