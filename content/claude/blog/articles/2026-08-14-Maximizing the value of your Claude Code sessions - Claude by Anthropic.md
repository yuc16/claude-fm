---
title: Maximizing the value of your Claude Code sessions | Claude by Anthropic
url: https://claude.com/blog/maximizing-the-value-of-your-claude-code-sessions
source: blog
published: '2026-08-14'
fetched: 2026-08-16 14:51
---
...
- **Run**This prevents prior irrelevant context from being sent back to the model, which can reduce token usage.- `/clear`between tasks.
...
- `/model`
- `/effort:`- `/model`and- `/effort`ask you to confirm when you switch in the middle of a conversation.
